...
export default class Camera {
    ...
    drawInfoText(gameState) {
        ...
        if (this.playback.isRoundTransition) {
            ...
            if (score.team0 > gameState.score.team0)
                scoreText = score.team0 == winningScore ? "Team 0 Wins!" : "Team 0 Scores!";
            else if (score.team1 > gameState.score.team1)
                scoreText = score.team1 == winningScore ? "Team 1 Wins!" : "Team 1 Scores!";
            else
                scoreText = "Time's Up!";
            context.textAlign = "center";
        ...
        switch (e.code) {
            ...
            case "KeyG":
                if (this.playback.running)
                    return;
                if (e.shiftKey)
                    this.playback.currentStateIndex--;
                else
                    this.playback.currentStateIndex++;
                break;
        }
